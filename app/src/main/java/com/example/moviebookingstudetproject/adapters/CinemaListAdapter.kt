...
class CinemaListAdapter(val delegate: SeatItemDelegate,val delegateTwo:SeatItemDelegateSeeDetail):RecyclerView.Adapter<CinemaListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CinemaListViewHolder {
        ...
        return CinemaListViewHolder(view,delegate,delegateTwo)
    }
